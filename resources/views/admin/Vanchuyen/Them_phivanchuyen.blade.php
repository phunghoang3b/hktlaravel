            ...
            <section class="panel">
                ...
                <div class="panel-body">
                    <div class="position-center">
                        <form>
                            @csrf                               
                        <div class="form-group" style="position: relative;left: 26%;width: 50%; text-align: center;">
                        ...
                        <button type="button" name="add_delivery" class="btn btn-info add_delivery" style="position: relative;left: 42%;">Thêm phí vận chuyển</button>
                        <?php
