            ...
            <div class="panel-body">
                <div class="position-center">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" data-validation="length" data-validation-length="min5" data-validation-error-msg="Hãy nhập tên sản phẩm và lớn hơn 5 ký tự" name="ten_sanpham" class="form-control" onkeyup="ChangeToSlug();" id="slug">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" required name="hinhanh_sanpham" class="form-control" id="exampleInputEmail1">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <textarea style="resize: none;" rows="8" class="form-control" data-validation="length" data-validation-length="min5" data-validation-error-msg="Hãy nhập mô tả sản phẩm và lớn hơn 5 ký tự" name="mota_sanpham" id="ckeditor1"></textarea>
                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword1">Nội dung sản phẩm</label>
                        <textarea style="resize: none;" rows="8" class="form-control" data-validation="length" data-validation-length="min5" data-validation-error-msg="Hãy nhập nội dung sản phẩm và lớn hơn 5 ký tự" name="noidung_sanpham" id="ckeditor"></textarea>
                    </div>
                    <div class="form-group">
