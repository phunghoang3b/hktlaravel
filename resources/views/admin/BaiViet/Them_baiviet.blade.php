            ...
            <div class="panel-body">
                <div class="position-center">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="ten_baiviet" class="form-control" id="slug" onkeyup="ChangeToSlug();">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <textarea style="resize: none;" rows="8" class="form-control" name="desc_baiviet" id="ckeditor"></textarea>
                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword1">Nội dung bài viết</label>
                        <textarea style="resize: none;" rows="8" class="form-control" name="cotent_baiviet" id="ckeditor1"></textarea>
                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword1">Meta từ khóa</label>
                        <textarea style="resize: none;" rows="5" class="form-control" name="meta_keywords" id="exampleInputPassword1"></textarea>
                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword1">Meta nội dung</label>
                        <textarea style="resize: none;" rows="5" class="form-control" name="meta_desc" id="exampleInputPassword1"></textarea>
                    </div>
                    <div class="form-group">
